...
export const options = {
    stages: [
        { duration: '10s', target: 10 }, // Ramp up to 50 users over 1 minute
        { duration: '20s', target: 10 }, // Stay at 50 users for 3 minutes
...
export default function () {
    ...
    const url = `${prodUrl}/api/v2/leave/eboss/staff/my-leave` 
    ...
    const params = {
        headers: {
            ...
            'x-encrypted-key': '..LUAOosCZRCaZDvgNuPYRAipQfxPy3Hll_ZHyg-BlLJImUYTXP_ScK5hfarqd55dTh20nUh94tNFmo_RuouyCosrvuHPSkpOwemZn7OUVEXUTUEyDTkMo6vRBc0D6ln3hPL96YAfErQ-u0V-V_cIn8hCA1ZKm0TH-xU7_c54_aDY2zxzec-BKPJlwihJfIl4OmuK9iDNriQGyL78X1pgf3LQJwo-egR8IJxnlJoNo229YUp9nxaz4AgeWgU_vjI5IhE15EAK-uP_KfI0Ynl72WQ3qoSx42GCXTFVGFsKiLR9P79KCQ_g3zKmFAXcGkngi9fTqQVDTfD5wKWRvXqdBmA',
